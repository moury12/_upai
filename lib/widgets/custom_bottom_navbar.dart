      ...
      items: <BottomNavigationBarItem>[
        BottomNavigationBarItem(
          icon: SvgPicture.asset(
            ...
            color: _selectedIndex == 0 ? selectedColor : unselected,
          ),
          label: 'Home',
        ),
        BottomNavigationBarItem(
          icon: SvgPicture.asset(
            ...
            color: _selectedIndex == 1 ? selectedColor : unselected,
          ),
          label: 'Inbox',
        ),
        BottomNavigationBarItem(
          icon: SvgPicture.asset(
            ...
            color: _selectedIndex == 2 ? selectedColor : unselected,
          ),
          label: 'Explore',
        ),
        BottomNavigationBarItem(
          icon: SvgPicture.asset(
            ...
            color: _selectedIndex == 3 ? selectedColor : unselected,
          ),
          label: 'Person',
        ),
      ],
