...
import 'package:upai/widgets/language_selector.dart';
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Obx(() {
                                return Text(
                                  ProfileScreenController.to.userInfo.value.name
                                      .toString()
                                      .toUpperCase(),
                                  maxLines: 2,
...
class CurvedPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(
        size.width * 0.15, height, size.width * 0.45, height * 0.85);
    path.quadraticBezierTo(
        size.width * 0.85, height * 0.70, size.width, height * 0.85);
